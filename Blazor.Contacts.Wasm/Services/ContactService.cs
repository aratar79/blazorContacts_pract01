...
namespace Services
{
    public class ContactService : IContactService
    {
        ...
        public async Task DeleteContact(int id) => await _httpClient.DeleteAsync($"api/contacts/{id}");
        public async Task<IEnumerable<Contact>> GetAll() => await _httpClient.GetFromJsonAsync<IEnumerable<Contact>>($"api/contacts");
